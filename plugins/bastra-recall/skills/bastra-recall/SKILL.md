...
---
<!-- GENERATED from packages/skill/SKILL.md (canonical 8d2ece37ca9e36f3) by scripts/build-skill-projections.mjs — do not edit; edit the canonical file and run `npm run skill:build` -->
